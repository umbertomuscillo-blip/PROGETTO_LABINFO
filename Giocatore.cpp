// Giocatore.cpp
// Implementazione dei metodi della classe Giocatore.
...
// Costruttore: inizializza l'identità del giocatore.
...
// * Parametro: nomeGiocatore Stringa contenente il nome scelto.
// Parametro: bot Booleano: true se il giocatore è controllato dall'Intelligenza Artificiale.
...
// * Parametro: c L'oggetto Carta pescato dal mazzo.
void Giocatore::pescaCarta(Carta c) { 
    mano.push_back(c); 
}

// Estrae una carta dalla mano per poterla giocare sul tavolo.
...
// * Parametro: indice La posizione (0-based) della carta selezionata nella mano.
// Ritorna: La Carta estratta, pronta per essere messa sul tavolo.
...
// Stampa formattata sul terminale di tutte le carte possedute.
// (Metodo utilizzato per la versione testuale del gioco o per il debug).
// * Parametro: latoOscuroAttivo Indica quale faccia della carta deve essere stampata.
